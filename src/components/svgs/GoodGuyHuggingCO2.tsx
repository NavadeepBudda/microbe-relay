...
export const GoodGuyHuggingCO2: React.FC<Props> = ({ moleculeType = 'CO2', ...props }) => {

    // Determine the text elements based on molecule type
    const renderMoleculeText = () => {
        if (moleculeType === 'N2O') {
            return (
                <text x="0" y="15" textAnchor="middle" fontFamily="Arial, sans-serif" fontSize="30" fontWeight="bold" fill="#0277bd" style={{ letterSpacing: '-1px' }}>
                    N<tspan dy="10" fontSize="24">2</tspan><tspan dy="-10">O</tspan>
                </text>
            );
            ...
            return (
                <text x="0" y="15" textAnchor="middle" fontFamily="Arial, sans-serif" fontSize="32" fontWeight="bold" fill="#0277bd" style={{ letterSpacing: '-1px' }}>
                    N<tspan dy="10" fontSize="24">2</tspan>
                </text>
            );
        } else {
            // Default CO2
